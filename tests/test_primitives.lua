...
--   assert(fw.to_hex(lump.serialize(3.0))  == MAGIC .. "12 00 00 00 00 00 00 08 40")
--   assert(fw.to_hex(lump.serialize(-2.0)) == MAGIC .. "12 00 00 00 00 00 00 00 C0")
-- end)

fw.test("serialization: zero/one", function()
  assert(fw.to_hex(lump.serialize(0)) == MAGIC .. "03")
  assert(fw.to_hex(lump.serialize(1)) == MAGIC .. "04")
end)

fw.test("serialization: string", function()
  assert(fw.to_hex(lump.serialize("Hello, world!")) == MAGIC .. "20 0D 48 65 6C 6C 6F 2C 20 77 6F 72 6C 64 21")
end)
